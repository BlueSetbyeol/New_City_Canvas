...
var userRepository_1 = __importDefault(require("../user/userRepository"));
var login = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, verified, hashed_password, userWithoutHashedPassword, myPayload, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                return [4 /*yield*/, userRepository_1.default.readByEmailWithPassword(req.body.email)];
            case 1:
                user = _a.sent();
                if (!user) {
                ...
                return [4 /*yield*/, argon2_1.default.verify(user.hashed_password, req.body.password)];
            case 2:
                verified = _a.sent();
                if (!verified) return [3 /*break*/, 4];
                hashed_password = user.hashed_password, userWithoutHashedPassword = __rest(user, ["hashed_password"]);
                myPayload = {
                    id: user.id.toString(),
                    mail: user.email,
                };
                return [4 /*yield*/, jsonwebtoken_1.default.sign(myPayload, process.env.APP_SECRET, {
                        expiresIn: "1h",
                    })];
            case 3:
                token = _a.sent();
...
var hashingOptions = {
    ...
    memoryCost: 19 * Math.pow(2, 10) /* 19 Mio en kio (19 * 1024 kio) */,
    timeCost: 2,
    parallelism: 1,
};
var hashPassword = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var password, hashedPassword, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var verifyToken = function (req, res, next) {
    try {
        ...
        req.body.auth = jsonwebtoken_1.default.verify(token, process.env.APP_SECRET);
        next();
    }
    catch (err) {
        console.error(err);
...
exports.default = { login: login, hashPassword: hashPassword, verifyToken: verifyToken };
