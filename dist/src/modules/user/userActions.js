...
var read = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = Number(req.body.auth.id);
...
var add = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var currentDate, newUser, insertId, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, userRepository_1.default.create(newUser)];
            case 2:
                insertId = _a.sent();
                if (insertId) {
...
exports.default = { read: read, add: add, edit: edit };
